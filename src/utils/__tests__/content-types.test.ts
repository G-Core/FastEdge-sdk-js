  ...
  describe('getKnownContentTypes', () => {
    ...
    describe('validation and error handling', () => {
      ...
      it('should ignore invalid contentType property', () => {
        expect.assertions(2);
        const invalidTypes = [
          { test: /\.valid$/, contentType: 'invalid-no-slash' },
          { test: /\.valid$/, contentType: 123 },
          { test: /\.valid$/, contentType: null },
          { test: /\.valid$/, contentType: undefined },
          { test: /\.valid$/, contentType: '' },
        ] as any;
      ...
      it('should handle mixed valid and invalid custom types', () => {
        expect.assertions(2);
        const mixedTypes = [
          { test: /\.valid$/, contentType: 'application/valid' }, // Valid
          { test: 'invalid', contentType: 'application/invalid' }, // Invalid test
          { test: /\.valid2$/, contentType: 'application/valid2' }, // Valid
          { test: /\.valid3$/, contentType: 'invalid-type' }, // Invalid contentType
        ] as any;
      ...
      it('should validate that contentType contains a slash', () => {
        expect.assertions(2);
        const invalidTypes = [
          { test: /\.test$/, contentType: 'validtype' }, // No slash
          { test: /\.test$/, contentType: 'application/valid' }, // Valid
        ] as any;
