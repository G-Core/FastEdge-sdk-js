#ifndef FASTEDGE_RUNTIME_ALLOCATOR_H
#define FASTEDGE_RUNTIME_ALLOCATOR_H
...
/// global that can be used there. This global is initialized in fastedge-runtime.cpp.
