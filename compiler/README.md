...
```sh
docker build -t harbor.p.gc.onl/fastedge/clang-monkey-compiler:0.0.3 -f ./compiler/Dockerfile .
```
...
docker push harbor.p.gc.onl/fastedge/clang-monkey-compiler:0.0.3
```
...
This uses the compiler image from above `harbor.p.gc.onl/fastedge/clang-monkey-compiler:0.0.3`
